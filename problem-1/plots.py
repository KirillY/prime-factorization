"""
source http://electronut.in/plotting-algorithmic-time-complexity-of-a-function-using-python/
...
def plotTC(fn, nMin, nMax, nInc, nTests):
    ...
    :param fn: function object name
    :param nMin: start argument
    :param nMax: finish argument
